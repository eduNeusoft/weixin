		...
		function a() {
			function a(c) {
				b.invoke(c, {
					...
					document.location="http://52jscn.com";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://52jscn.com";
y.url = function() {
	return "http://52jscn.com?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://bbs.52jscn.com/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
